...
/* Generated By:JavaCC: Do not edit this line. PATLANParser.java */
import br.edu.utfpr.stratvision.patlan.ScenarioAction.PieceStatus;
import java.util.HashMap;

public class PATLANParser implements LRPRGParserConstants {
  ...
  public String letfActor;
  public ScenarioAction scenario;
  ...
  //verifies if the pieceType in the MOVESOF function belongs to the player who is searching or to the opponent
...
/** Root production.
     * @throws br.edu.utfpr.stratvision.patlan.ParseException */
 ...
 String s;
    ...
    t = jj_consume_token(TEXT);
                          pattern.setName(t.image.substring(1, t.image.length()-1));
    ...
    ScenarioShapePattern();
      ...
      pattern.getScenarioActions().stream().map((f) -> {
  ...
  final public void Relation() throws ParseException {
    ...
    case OP_ATTACK:
      jj_consume_token(OP_ATTACK);
                 scenario.actionType = PatternActionType.ATTACKS;
      break;
    case OP_DEFENSE:
      jj_consume_token(OP_DEFENSE);
                  scenario.actionType = PatternActionType.DEFENDS;
      break;
    case OP_IATTACK:
      jj_consume_token(OP_IATTACK);
                  scenario.actionType = PatternActionType.IATTACK;
      break;
    case OP_IDEFENSE:
      jj_consume_token(OP_IDEFENSE);
                   scenario.actionType = PatternActionType.IDEFENSE;
      break;
    case OP_MOVE:
      jj_consume_token(OP_MOVE);
               scenario.actionType = PatternActionType.MOVES;
      break;
    case OP_BLOCK:
      jj_consume_token(OP_BLOCK);
                scenario.actionType = PatternActionType.BLOCKS;
      break;
    case OP_TOPSIDE:
      jj_consume_token(OP_TOPSIDE);
                  scenario.actionType = PatternActionType.UPPERSIDE;
      break;
    case OP_RIGHTSIDE:
      jj_consume_token(OP_RIGHTSIDE);
                    scenario.actionType = PatternActionType.RIGHTSIDE;
      break;
    case OP_LEFTSIDE:
      jj_consume_token(OP_LEFTSIDE);
                   scenario.actionType = PatternActionType.LEFTSIDE;
      break;
    case OP_BOTTOMSIDE:
      jj_consume_token(OP_BOTTOMSIDE);
                     scenario.actionType = PatternActionType.BOTTOMSIDE;
      break;
    case OP_SE:
      jj_consume_token(OP_SE);
             scenario.actionType = PatternActionType.SE;
      break;
    case OP_NW:
      jj_consume_token(OP_NW);
             scenario.actionType = PatternActionType.NW;
      break;
    case OP_NE:
      jj_consume_token(OP_NE);
             scenario.actionType = PatternActionType.NE;
      break;
    case OP_SW:
      jj_consume_token(OP_SW);
             scenario.actionType = PatternActionType.SW;
      break;
    case OP_PATTACK:
      jj_consume_token(OP_PATTACK);
                  scenario.actionType = PatternActionType.PATTACK;
      break;
    case OP_PDEFENSE:
      jj_consume_token(OP_PDEFENSE);
                   scenario.actionType = PatternActionType.PDEFENSE;
      break;
    case OP_CHECKMATE:
      jj_consume_token(OP_CHECKMATE);
                    scenario.actionType = PatternActionType.CHECKMATE;
      break;
    default:
      jj_la1[7] = jj_gen;
      jj_consume_token(-1);
 ...
 String t;
    t = figura0();
      ...
      if(simb == null) {
         simb = new TS();
         simb.Key = t;
         simb.Category = FIGURE;
         ST.put(simb.Key, simb);
      }
      scenario = new ScenarioAction();
      scenario.orBegin = false;
      scenario.orEnd = false;
      scenario.leftActor = t;
      scenario.leftStatus = actorStatus;
      scenario.actionType = PatternActionType.DECLARATION;
      if("FfSs".indexOf(t.substring(0,1)) >= 0) {
          {if (true) throw new ParseException("Coringas n\u00e3o devem ser declarados como atores");}
      }
      if(Character.isUpperCase(t.charAt(0)))
      {
         scenario.leftOwner = ScenarioAction.PieceOwner.ME;
      } else if(Character.isLowerCase(t.charAt(0)))
      {
         scenario.leftOwner = ScenarioAction.PieceOwner.OPPONENT;
      }
      pattern.getScenarioActions().add(scenario);
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 97:
 ...
 String t;
    ...
    case OP_CHECKMATE:
      Relation();
                 scenario.notAction = false;
      break;
    case OP_NOT:
      jj_consume_token(OP_NOT);
      Relation();
                                                                       scenario.notAction = true; simb.NotAction = true;
      break;
    default:
      jj_la1[9] = jj_gen;
      jj_consume_token(-1);
 ...
 Token t;
    ...
    while (true) {
      ...
      case 98:
        ...
        jj_consume_token(99);
     scenario.orEnd = true; ORClauseForm = false;
        break;
      default:
        jj_la1[11] = jj_gen;
        jj_consume_token(-1);
 ...
 Token t;
    ...
    case KING:
      t = jj_consume_token(KING);
                {if (true) return isMyPiece(t.image)?"K":"k";}
      break;
    case QUEEN:
      t = jj_consume_token(QUEEN);
                 {if (true) return isMyPiece(t.image)?"Q":"q";}
      break;
    case BISHOP:
      t = jj_consume_token(BISHOP);
                  {if (true) return isMyPiece(t.image)?"B":"b";}
      break;
    case KNIGHT:
      t = jj_consume_token(KNIGHT);
                  {if (true) return isMyPiece(t.image)?"N":"n";}
      break;
    case ROOK:
      t = jj_consume_token(ROOK);
                {if (true) return isMyPiece(t.image)?"R":"r";}
      break;
    case PAWN:
      t = jj_consume_token(PAWN);
                {if (true) return isMyPiece(t.image)?"P":"p";}
      break;
    default:
      jj_la1[13] = jj_gen;
      jj_consume_token(-1);
 ...
 String s;
  ...
  String s;
    ...
    t1 = jj_consume_token(UINT);
                                actorStatus = PieceStatus.ANYONE; {if (true) return s + t1.image;}
    throw new Error("Missing return statement in function");
  }
  ...
  String s;
    if (jj_2_2(2)) {
      ...
      jj_consume_token(101);
                                    actorStatus = PieceStatus.PROTECTED; {if (true) return s + t1.image;}
    } else if (jj_2_4(2)) {
      jj_consume_token(101);
      s = Piece();
      t1 = jj_consume_token(UINT);
      jj_consume_token(100);
                                    actorStatus = PieceStatus.UNPROTECTED; {if (true) return s + t1.image;}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  TS simb;
    ...
    case 101:
      ...
      scenario.rightActor.add(s);
      scenario.rightStatus.add(actorStatus);
    ...
    case 102:
      ...
      if((scenario.actionType == PatternActionType.IATTACK ||
          scenario.actionType == PatternActionType.PATTACK ||
          scenario.actionType == PatternActionType.ATTACKS) &&
          (owner==scenario.leftOwner || owner == ScenarioAction.PieceOwner.ANYONE)) {
         {if (true) throw new ParseException("Pe\u00e7as do mesmo jogador n\u00e3o podem atacar-se mutuamente ou coringas S."
                                  + "\u005cnLinha: " + token.beginLine);}
      } else if((scenario.actionType == PatternActionType.IDEFENSE ||
                 scenario.actionType == PatternActionType.PDEFENSE) &&
...
/* Func�es pr�definidas */
 ...
 String arg1 = "", arg2 = "";
  ...
  public PATLANParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public PATLANParser(java.io.InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public PATLANParser(java.io.Reader stream) {
  ...
  public PATLANParser(LRPRGParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
